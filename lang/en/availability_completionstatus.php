...
$string['option_complete'] = 'must be completed';
...
$string['option_previous'] = 'Previous activity with completion status';
$string['pluginname'] = 'Restriction by activity completion status';
...
$string['title'] = 'Activity completion status';
$string['privacy:metadata'] = 'The Restriction by activity completion status plugin does not store any personal data.';
