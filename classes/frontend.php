...
class frontend extends \core_availability\frontend {
    ...
    protected function get_javascript_init_params($course, \cm_info $cm = null,
        ...
        if ($cachekey !== $this->cachekey) {
            ...
            if ($previouscm) {
                $previous = (object)['id' => \availability_completionstatus\condition::OPTION_PREVIOUS,
                        'name' => get_string('option_previous', 'availability_completionstatus'),
                        'completiongradeitemnumber' => \availability_completionstatus\condition::OPTION_PREVIOUS];
